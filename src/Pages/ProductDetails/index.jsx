                    ...
                    <div className="productContent w-[60%] p-3">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="flex items-center gap-1 actions">
                                <Button
                                    className={`${productActionIndex === 0 ? "!bg-[var(--bg-primary)] !text-white" : ""} ${totalStocks === 0 ? "!cursor-not-allowed !text-gray-400" : ""}`}
                                    onClick={() => { totalStocks !== 0 && setProductActionIndex(0) }} disableRipple={totalStocks === 0}>
                                    S
                                </Button>
                                <Button
                                    className={`${productActionIndex === 1 ? "!bg-[var(--bg-primary)] !text-white" : ""} ${totalStocks === 0 ? "!cursor-not-allowed !text-gray-400" : ""}`}
                                    onClick={() => { totalStocks !== 0 && setProductActionIndex(1) }} disableRipple={totalStocks === 0}>
                                    M
                                </Button>
                                <Button
                                    className={`${productActionIndex === 2 ? "!bg-[var(--bg-primary)] !text-white" : ""} ${totalStocks === 0 ? "!cursor-not-allowed !text-gray-400" : ""}`}
                                    onClick={() => { totalStocks !== 0 && setProductActionIndex(2) }} disableRipple={totalStocks === 0}>
                                    L
                                </Button>
                                <Button
                                    className={`${productActionIndex === 3 ? "!bg-[var(--bg-primary)] !text-white" : ""} ${totalStocks === 0 ? "!cursor-not-allowed !text-gray-400" : ""}`}
                                    onClick={() => { totalStocks !== 0 && setProductActionIndex(3) }} disableRipple={totalStocks === 0}>
                                    XL
                                </Button>
                                <Button
                                    className={`${productActionIndex === 4 ? "!bg-[var(--bg-primary)] !text-white" : ""} ${totalStocks === 0 ? "!cursor-not-allowed !text-gray-400" : ""}`}
                                                ...
                                                <tbody>
                                                    <tr className="bg-white border-b">
                                                        <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                            Apple MacBook Pro 17"Apple MacBook Pro 17"Apple MacBook
                                                        </th>
