                ...
                <div className={`leftPart w-[70%]`}>
                    <div className="h-[100%] shadow-md rounded-md bg-white flex flex-col gap-2">
                        <div className="py-2 px-3">
                            ...
                            <p className="mt-0">There are <span className="font-bold text-[var(--bg-primary)]">{context?.cartData?.length}</span> product{context?.cartData?.length <= 1 ? ("") : ("s")} in your cart</p>
                        </div>
                        <Divider />
