                    ...
                    <div className="leftPart w-[70%]">
                        <div className="shadow-md rounded-md bg-white flex flex-col gap-2">
                            ...
                            <div className="pt-10 pb-2 px-5">
                                <h2 className="text-[var(--text-light)] font-bold uppercase">Address</h2>
                            </div>
                            <Divider />
                            ...
                            <div className="flex items-center flex-col py-2 pb-10 px-5 gap-4">
                                ...
                                <div className="w-full flex justify-between">
                                    <TextField id="city" label="City / District" name="city" required variant="outlined" className="custom-textfield w-[49%] mb-5" size="small" />
                                    <TextField id="state" label="State" name="state" required variant="outlined" className="custom-textfield w-[49%] mb-5" size="small" />
                                </div>
                            </div>
                        </div>
                    </div>
