...
const AddProduct = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        // Reset select dropdowns explicitly if needed
        setProductCategory('');
    ...
    const handleDiscard = () => {
        // Reset the select dropdown states explicitly
        setProductCategory('');
        setProductSubCategory('');
        setProductFeatured('');
        setProductRams('');
            ...
            <form action="" ref={formRef} onSubmit={handleFormSubmit} className='form py-3'>
                ...
                <div className="grid grid-cols-4 mb-3 gap-4 border-2 border-dashed border-[rgba(0,0,0,0.1)] rounded-md p-5">
                    ...
                    <div className='col'>
                        ...
                        <Rating name="half-rating" value={productRating} onChange={(event, newValue) => setProductRating(newValue)} precision={0.5} />
