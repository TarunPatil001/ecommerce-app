...
const AddWeight = () => {
    ...
    return (
        <>
            <div className='flex items-center justify-between px-5 mt-14'>
                        ...
                        <div className='grid grid-cols-1'>
                            <div className='col'>
                                <div className='flex items-center gap-2 mb-1'>
                                    ...
                                    <span className='text-gray-400 text-[14px]'>(for eg. 50gm, 10kg,...)</span>
                                </div>
                                <input
                                    type='text'
                                ...
                                <div className='flex items-center gap-4'>
                                    <Button
                                        ...
                                        className='!capitalize !bg-red-500 !text-white !px-5 w-full sm:w-[150px] h-[40px] flex items-center justify-center gap-2 '
                                    >
                                        <RiResetLeftFill className='text-[18px] hidden sm:block' />Discard
                                    </Button>
                                    <Button
                                        type='submit'
                                        className={`!capitalize !px-5 w-full sm:w-[150px] h-[40px] flex items-center justify-center gap-2 ${weightId ? (isLoading ? "custom-btn-update-disabled" : "custom-btn-update") : (isLoading ? "custom-btn-disabled" : "custom-btn")}`}
                                        disabled={isLoading}
                                    >
                                        {isLoading ? <CircularProgress color='inherit' /> : weightId ? <><FiEdit className='text-[18px] hidden sm:block' /> Update</> : <><IoIosSave className='text-[18px] hidden sm:block' /> Create</>}
                                    </Button>
                                </div>
                            </div>
                        </div>
...

                    {
                        ...
                        <div className='sticky bottom-0 left-0 z-10 mt-2.5 flex w-full items-center justify-between rounded-md border border-gray-200 bg-gray-0 px-5 py-3.5 text-gray-900 shadow bg-white gap-4'>
                            ...
                            <Button
                                ...
                                className='!bg-red-500 !text-white !capitalize !px-5 w-auto h-[40px] flex items-center justify-center gap-2'
                            >
